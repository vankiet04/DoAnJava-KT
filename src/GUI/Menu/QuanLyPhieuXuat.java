...
public class QuanLyPhieuXuat extends javax.swing.JPanel {
    ...
    public void Fillter() throws ParseException {
        ...
        // neu bat dau hoac  ket thuc lon hon hien tai
        ...
        // neu ngay bat dau lon hon hien tia
        if (ngaybatdau != null && ngaybatdau.after(new java.util.Date())) {
            JOptionPane.showMessageDialog(this, "Ngày bắt đầu không được lớn hơn ngày hiện tại", "Lỗi",
                    JOptionPane.ERROR_MESSAGE);
                    //refresh lại ngày
        ...
        // if only ngaybatdau then ngayketthuc = now
        if (ngaybatdau != null && ngayketthuc == null) {
            ngayketthuc = new java.util.Date();
        }
        // if ngay batdaus is null, alert and return
        if (ngaybatdau == null && ngayketthuc != null) {
