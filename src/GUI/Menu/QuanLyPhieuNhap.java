...
public class QuanLyPhieuNhap extends javax.swing.JPanel {
    ...
    public void Fillter() throws ParseException {
        ...
        // neu ngay bat dau khac null và ket thuc null thì ket thuc  = now
        if (ngaybatdau != null && ngayketthuc == null) {
            jDateChooser2.setDate(new java.util.Date());
            ngayketthuc = new java.util.Date();
        }
        // neu bat dau hoac ket thuc lon hon ngay hien tai => alert and return
        if (ngaybatdau != null && ngaybatdau.after(new java.util.Date())) {
        ...
        if (ngayketthuc != null && ngayketthuc.after(new java.util.Date())) {
        ...
        // neu ngay bat dau null => alert and return
        if (ngaybatdau == null && ngayketthuc != null) {
    ...
    public void loadDataTalbe(ArrayList<DTO_PhieuNhap> list) {
        ...
        jTablePN.setDefaultEditor(Object.class, null);
    }
