...
form KhachHangDialog
    ...
    private void jToggleButton1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jToggleButton1MousePressed
        ...
        if (!diachi.matches("[a-zA-Z\\p{L}].*")) {
            JOptionPane.showMessageDialog(null, "Địa chỉ phải bắt đầu bằng chữ cái");
            return;
        } else if (!diachi.matches("[a-zA-Z0-9\\p{L}\\s,\\./]+")) {
            JOptionPane.showMessageDialog(null, "Địa chỉ không được chứa ký tự đặc biệt ngoại trừ dấu '/'");
            return;
        }
