...
public class SuaNhomQuyen extends javax.swing.JDialog {
    ...
    private void jButton1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MousePressed
        ...
        if (!tenQuyen.matches("[a-zA-Z0-9 ]+")) {
            JOptionPane.showMessageDialog(null, "Không được chứa ký tự đặc biệt");
            return;
        }
        ...
        for (int i = 0; i < 10; i++) {
            ...
            for (int j = 0; j < 4; j++) {
                JCheckBox checkBox = listCheckBox.get(i).get(j);  // Assuming listCheckBox[i] contains 4 JCheckBox items
                if (checkBox.isSelected()) {
                    cnt++;
                    chucnang.add(map.get(j));  // map has "view", "create", etc.
                }
            }
